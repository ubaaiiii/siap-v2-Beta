...
class LoginController extends Controller
{
    ...
    public function adminLogin(Request $request)
    {
        ...
        if ($data = DB::select("SELECT * FROM ms_admin WHERE username='$request->username' AND password='$password'")) {
            ...
            setcookie('layoutmode', $data[0]->layoutmode, time() + (86400 * 30), "/"); // 86400 = 1 day
            setcookie('setimagepath', $data[0]->setimagepath, time() + (86400 * 30), "/"); // 86400 = 1 day
            setcookie('setmenu', $data[0]->setmenu, time() + (86400 * 30), "/"); // 86400 = 1 day
            setcookie('setstylesheet', $data[0]->setstylesheet, time() + (86400 * 30), "/"); // 86400 = 1 day
