...
<main class="h-100 has-header">
    ...
    <div class="main-container container">
        ...
        <div class="row h-100 mb-4">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="form-group form-floating  mb-3">
                    <input type="number" class="form-control" name="noktp" value="{{ '' }}" placeholder="Name"
                        id="names">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="form-group form-floating  mb-3">
                    <input type="date" class="form-control" id="tgllahir" name="tgllahir" onchange="hitungUsia()"
                        placeholder="Tanggal Lahir" id="surnames">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="form-group form-floating  mb-3">
                    <input type="date" class="form-control" id="mulai" name="mulai" onchange="hitungUsia()"
                        placeholder="Mulai Asuransi" id="surnames">
                    <label for="surnames">Mulai Asuransi</label>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
                <div class="form-group form-floating  mb-3">
                    <input type="text" class="form-control" id="akhir" name="akhir" placeholder="Akhir Asuransi"
                        id="surnames">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="form-group form-floating  mb-3">
                    <input type="text" class="form-control" name="usia" id="usia" readonly
                        placeholder="Usia Pada Akhir Asuransi" id="surnames">
                    <label for="surnames">Usia Pada Akhir Asuransi</label>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
                <div class="form-group form-floating  mb-3">
                    <input type="number" class="form-control" name="masa" id="masa" placeholder="Masa Asuransi"
                        id="surnames" onchange="hitungUsia()">
                    <label for="surnames">Masa Asuransi</label>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
                <div class="form-group form-floating  mb-3">
                    <input type="text" class="form-control" id="up" name="up" placeholder="dalam rupiah"
                        required="required" onkeydown="return numbersonly(this, event);"
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="form-group form-floating  mb-3">
                    <input type="number" class="form-control" id="tunggakan" name="tunggakan" min="0" max="1000"
                        placeholder="dalam bulan" required="required">
