...
<main class="h-100 has-header">
        ...
        <div class="main-container container">
            ...
            <form action="{{ url('mitra/update') }}" method="post">
            @csrf
            <!-- <input type="hidden" name="id_member_mitra"> -->
                    ...
                    <div class="toast-body">
                        <div class="row">
                            ...
                            <div class="col-auto align-self-center ps-0">
                                ...
                                <a href="{{ url('mitra/delete/'.Crypt::encryptString($data[0]->msid)) }}" class="btn btn-sm btn-default btn-delete" >Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
