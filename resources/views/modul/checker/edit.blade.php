                    ...
                    <div class="swiper-container connectionwiper" style="overflow: scroll;">
                        ...
                        <div class="swiper-wrapper" id="statistic_family">
                            <div class="swiper-slide">
                                <a href="{{ url('checker/approve/'.Crypt::encryptString($data[0]->regid)) }}" class="card text-center">
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <a href="{{ url('checker/rollback/'.Crypt::encryptString($data[0]->regid)) }}" class="card text-center">
                                    <div class="card-body">
                                        <div class="avatar avatar-50 shadow-sm mb-2 rounded-10 theme-bg text-white">
                                            <i class="bi bi-reject size-32"></i>
                                        </div>
