        ...
        <div class="main-container container">
            ...
            <form method="POST" action="{{ url('verifikasi/update')}}">
                ...
                <div class="row h-100 mb-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group form-floating  mb-3">
                            <input type="text" class="form-control" readonly name="usiaakhir" value="{{ $data[0]->usiaakhir }}" placeholder="Tempat Lahir" id="names">
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group form-floating  mb-3">
                            <input type="text" class="form-control" readonly name="nama_ahli_waris" value="{{ $data[0]->nama_ahli_waris }}" placeholder="nama_ahli_waris" id="names">
                            <label for="names">Nama Ahli Waris</label>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group form-floating  mb-3">
                            <input type="text" class="form-control" readonly name="notelp_ahli_waris" value="{{ $data[0]->notelp_ahli_waris }}" placeholder="notelp_ahli_waris" id="names">
                            <label for="names">No Telp Ahli Waris</label>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="form-floating mb-3">
                            <select readonly class="form-control" id="country" name="hubungan" id="hubungan">
                                <option value="" ></option>
