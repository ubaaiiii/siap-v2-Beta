...
<main class="h-100 has-header">
        ...
        <div class="main-container container">
                ...
                <div class="col-12 px-0">
                    ...
                    <div class="swiper-container connectionwiper" style="overflow: scroll;">
                        ...
                        <div class="swiper-wrapper" id="statistic_family">
                            ...
                            @if($data[0]->status == "72" || $data[0]->status == "73" || $data[0]->status == "82" || $data[0]->status == "83") 
                            @else
                                @if(Session::get('login')[0]->level !== "insurance") 
                                <div class="swiper-slide">
                                    <a href="{{ url('pembatalan/edit/'.Crypt::encryptString($data[0]->regid)) }}" class="card text-center">
                                        <div class="card-body">
                                            <div class="avatar avatar-50 shadow-sm mb-2 rounded-10 theme-bg text-white">
                                                <i class="bi bi-check2-circle size-32"></i>
                                            </div>
                                            <p class="text-color-theme size-12 small">Edit</p>
                                        </div>
                                    </a>
                                </div>
                                @endif 
                            ...
                            <?php 
                                $jdoc = "DTRFN";
                                if ($data[0]->status == "7" || $data[0]->status == "71" || $data[0]->status == "72" || $data[0]->status == "73") {
                                    $jdoc = "DTBTL";
                                } 
                            ?>
                            <div class="swiper-slide">
                                <a href="{{ url('pembatalan/doc/'.Crypt::encryptString($data[0]->regid).'/'.$jdoc) }}" class="card text-center">
                                    <div class="card-body">
                                        <div class="avatar avatar-50 shadow-sm mb-2 rounded-10 theme-bg text-white">
                            ...
                            @if($data[0]->status == "7" || $data[0]->status == "8" || $data[0]->status == "71" || $data[0]->status == "72" || $data[0]->status == "73" || $data[0]->status == "81" || $data[0]->status == "82") 
                            <div class="swiper-slide">
                                <a href="{{ url('pembatalan/cetak/'.Crypt::encryptString($data[0]->policyno)) }}" class="card text-center">
                                    <div class="card-body">
                                        <div class="avatar avatar-50 shadow-sm mb-2 rounded-10 theme-bg text-white">
                                            <i class="bi bi-clipboard size-32"></i>
                                        </div>
                                        <p class="text-color-theme size-12 small">Cetak</p>
                                    </div>
                                </a>
                            </div>
                            @endif
                            @if(Session::get('login')[0]->level !== "schecker" && $data[0]->status == "7" || $data[0]->status == "8") 
                            <div class="swiper-slide">
                                <a href="{{ url('pembatalan/approve/'.Crypt::encryptString($data[0]->regid)) }}" class="card text-center">
                                    <div class="card-body">
                                        <div class="avatar avatar-50 shadow-sm mb-2 rounded-10 theme-bg text-white">
                                            <i class="bi bi-check2-circle size-32"></i>
                                        </div>
                            ...
                            @elseif(Session::get('login')[0]->level !== "broker")
                                @if($data[0]->status == "7" || $data[0]->status == "8" || $data[0]->status == "71" || $data[0]->status == "81")
                                    <div class="swiper-slide">
                                        <a href="{{ url('pembatalan/approve/'.Crypt::encryptString($data[0]->regid)) }}" class="card text-center">
                                            <div class="card-body">
                                                <div class="avatar avatar-50 shadow-sm mb-2 rounded-10 theme-bg text-white">
                                    ...
                                    <div class="swiper-slide">
                                        <a href="{{ url('pembatalan/cancel/'.Crypt::encryptString($data[0]->regid)) }}" class="card text-center">
                                            <div class="card-body">
                                                <div class="avatar avatar-50 shadow-sm mb-2 rounded-10 theme-bg text-white">
                                                    <i class="bi bi-check2-circle size-32"></i>
                                                </div>
                                                <p class="text-color-theme size-12 small">Cancel</p>
                                            </div>
                                        </a>
                                    </div>
                                @elseif($data[0]->status == "81")
                                    <div class="swiper-slide">
                                        <a href="{{ url('pembatalan/paid/'.Crypt::encryptString($data[0]->regid)) }}" class="card text-center">
                                            <div class="card-body">
                                                <div class="avatar avatar-50 shadow-sm mb-2 rounded-10 theme-bg text-white">
                                                    <i class="bi bi-check2-circle size-32"></i>
                                                </div>
                                                <p class="text-color-theme size-12 small">Paid</p>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="{{ url('pembatalan/batal/'.Crypt::encryptString($data[0]->regid)) }}" class="card text-center">
                                            <div class="card-body">
                                                <div class="avatar avatar-50 shadow-sm mb-2 rounded-10 theme-bg text-white">
                                                    <i class="bi bi-check2-circle size-32"></i>
                                                </div>
                                                <p class="text-color-theme size-12 small">Batal</p>
                                            </div>
                                        </a>
                                    </div>
                                @endif
                            @elseif(Session::get('login')[0]->level !== "insurance")
                                @if($data[0]->status == "84")
                                    @if($data[0]->bordero == "YES")
                                    <div class="swiper-slide">
                                        <a href="{{ url('pembatalan/paid/'.Crypt::encryptString($data[0]->regid)) }}" class="card text-center">
                                            <div class="card-body">
                                                <div class="avatar avatar-50 shadow-sm mb-2 rounded-10 theme-bg text-white">
                                    ...
                                    @elseif($data[0]->status == "72" || $data[0]->status == "82")
                                        <div class="swiper-slide">
                                            <a href="{{ url('pembatalan/approve/'.Crypt::encryptString($data[0]->regid)) }}" class="card text-center">
                                                <div class="card-body">
                                                    <div class="avatar avatar-50 shadow-sm mb-2 rounded-10 theme-bg text-white">
                            ...
                            ?>
                            <div class="swiper-slide">
                                <a href="{{ url('pembatalan/log/'.Crypt::encryptString($data[0]->regid).'/'.$typeLog) }}" class="card text-center">
                                    <div class="card-body">
                                        <div class="avatar avatar-50 shadow-sm mb-2 rounded-10 theme-bg text-white">
            ...
            @if($data[0]->status == "1") 
            <form method="POST" action="{{ url('pembatalan/update')}}">
                @csrf
            @endif
                <div class="row h-100 mb-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group form-floating  mb-3">
                            <input type="text" class="form-control" readonly name="tglbatal" value="{{ $data[0]->tglbatal }}" placeholder="tglbatal" id="names">
                            <label for="names">Tanggal Batal</label>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group form-floating  mb-3">
                            <input type="text" class="form-control" readonly name="refund" value="{{ $data[0]->refund }}" placeholder="refund" id="names">
                            <label for="names">Refund Premi</label>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group form-floating  mb-3">
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group form-floating  mb-3">
                            <input type="text" class="form-control" readonly name="reason" value="{{ $data[0]->reason }}" placeholder="reason" id="names">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach($dokumen as $d)
                                        <tr>
                                            <td><a href="{{ url($d->FILE) }}" target="pdf-frame">{{ $d->nama_file }} </a></td>
                                            <td>{{ $d->tipe_file }}</td>
                                            <td>{{ $d->ukuran_file }}</td>
                                            <th>
                        ...
                        <div class="toast-body">
                            <div class="row">
                                ...
                                <div class="col-auto align-self-center ps-0">
                                    ...
                                    <a href="{{ url('pembatalan/delete/'.$data[0]->regid) }}" class="btn btn-sm btn-default btn-delete" >Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
