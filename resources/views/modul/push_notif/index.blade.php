                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-auto">
                            ...
                            <a href="{{ url('/pembayaran/add')}}" tooltip="Tambah data" id="create_record" class="btn btn-44 btn-light shadow-sm">
                                <i class="bi bi-plus-circle"></i>
                            </a>
                    ...
                    <div class="col-md-6 card shadow mb-4 ">
                        ...
                        <div class="card border-0">
                            <div class="card-body">
                                ...
                                <a href="{{ url('pembayaran/edit/'. Crypt::encryptString($p->regid)) }}" class="btn btn-default w-100 shadow small">Detail</a>
                                <a onclick="return hapus()" class="btn btn-danger w-100 shadow small">Hapus</a>
