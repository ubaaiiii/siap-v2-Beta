                    ...
                    <div class="col-md-6 card shadow mb-4 ">
                        ...
                        <div class="card border-0">
                            <div class="card-body">
                                ...
                                <a href="{{ url('sertifikat/view/'.Crypt::encryptString($s->regid)) }}" class="btn btn-default w-100 shadow small">Detail</a>
