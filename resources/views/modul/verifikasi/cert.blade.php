			...
			<table style="width: 100%;">
				<tr > 
					<td class="judul_kop_rl">
						<img src="{{ url('assets/img/logo/logo'. strtolower($ms_insurance[0]->asuransi).'.jpg') }}" class="logo" style="width:80;height:80px;">
					</td>
					<td class="judul_kop">
						<h2 align="center" style="position: relative;left: -5rem;">{{ $ms_insurance[0]->nmasuransi }} </h2>
                        <h5 align="center" style="position: relative;left: -5rem;"><?php echo $ms_insurance[0]->alamat;?></h5>
						<h5 align="center" style="position: relative;left: -5rem;"><?php echo $ms_insurance[0]->alamat1 . " " .$ms_insurance[0]->alamat2 ;?></h5>
						<h5 align="center" style="position: relative;left: -5rem;"><?php echo "Telpon : " . $ms_insurance[0]->phone1 . " " . $ms_insurance[0]->phone2 . " Fax. : " . $ms_insurance[0]->fax1;?></h5>
						<h5 align="center" style="position: relative;left: -5rem;"><?php echo ($ms_insurance[0]->email!=''?'Email : '.$ms_insurance[0]->email:'');?></h5>
					</td> 
				</tr>
			</table>
		</div>
			...
			<table width="100%">
				...
				<tr>
					...
					<td style="width: 30%%; text-align: center;" >
						<img src="{{ url('assets/img/logo/kadivtek'.strtolower($ms_insurance[0]->asuransi).'.jpg') }}" style="width:200px;">
					</td>
				</tr>
				<tr>
					<td style="width: 18%;"></td>
					<td style="width: 30%; text-align: center;"></td>
					<td style="width: 18%"></td>
					<td style="width: 30%; text-align: center;"><?php echo $ms_insurance[0]->pic; ?><br> ________________<br> <?php echo $ms_insurance[0]->picjabat; ?> </td>
				</tr>
		</table>
		</div>
		<page_footer>
