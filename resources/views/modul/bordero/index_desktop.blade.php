                                ...
                                <div class="row h-100 mb-4">
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="form-group form-floating  mb-3">
                                            <input type="date" class="form-control" id="period1" required name="period1"  placeholder="Tanggal Bayar">
                                            <label for="surnames">Periode 1</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="form-group form-floating  mb-3">
                                            <input type="date" class="form-control" id="period2" required  name="period2"  placeholder="Tanggal Bayar">
