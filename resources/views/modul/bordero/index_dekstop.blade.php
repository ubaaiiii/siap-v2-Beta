        ...
        <div class="main-container container">
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div id="form">
                            <form method="post" action="{{ url('bordero/store') }}" />
                            @csrf
                                <div class="row h-100 mb-4">
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="form-group form-floating  mb-3">
                                            <input type="date" class="form-control" required id="period1"  name="period1"  placeholder="Tanggal Bayar">
                                            <label for="surnames">Periode 1</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="form-group form-floating  mb-3">
                                            <input type="date" class="form-control" required id="period2"  name="period2"  placeholder="Tanggal Bayar">
                                            <label for="surnames">Periode 2</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="form-group form-floating  mb-3">
                                            <select class="form-control" required name="sfilter3" id="select-transaksi" data-live-search="true">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="form-group form-floating  mb-3">
                                            <select class="form-control" required name="sfilter4" id="select-transaksi" data-live-search="true">
