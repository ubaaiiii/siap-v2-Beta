	                        ...
	                        <div class="card-body">
	                            <div class="row">
	                                ...
	                                <div class="col align-self-center ps-0">
	                                    <p class="small mb-1"><a href="{{ url('pengajuan/report/skkt/'.Crypt::encryptString($regid)) }}" class="fw-medium" terget="_blank">Form SKKT ( ASKRED) UPDATED</a> </p>
	                    ...
	                    <div class="card mb-3">
	                        <div class="card-body">
	                            <div class="row">
	                                ...
	                                <div class="col align-self-center ps-0">
	                                    <p class="small mb-1"><a href="{{ url('pengajuan/report/lpfk/'.Crypt::encryptString($regid)) }}" class="fw-medium" target="_blank">Laporan Pemeriksaan Fisik (LPK) - PLN INS</a> </p>
	                    ...
	                    <div class="card mb-3">
	                        <div class="card-body">
	                            <div class="row">
	                                ...
	                                <div class="col align-self-center ps-0">
	                                    <p class="small mb-1"><a href="{{ url('pengajuan/report/spa/'.Crypt::encryptString($regid)) }}" class="fw-medium" target="_blank">SPA - PLN INS</a> </p>
	                    ...
	                    <div class="card mb-3">
	                        <div class="card-body">
	                            <div class="row">
	                                ...
	                                <div class="col align-self-center ps-0">
	                                    <p class="small mb-1"><a href="{{ url('pengajuan/report/spm/'.Crypt::encryptString($regid)) }}" class="fw-medium" target="_blank">SPM - PLN INS</a> </p>
	                    ...
	                    <div class="card mb-3">
	                        <div class="card-body">
	                            <div class="row">
	                                ...
	                                <div class="col align-self-center ps-0">
	                                    <p class="small mb-1"><a href="{{ url('pengajuan/report/spkk/'.Crypt::encryptString($regid)) }}" class="fw-medium"  target="_blank">SPKK - PLN INS</a> </p>
