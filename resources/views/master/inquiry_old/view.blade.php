...
<main class="h-100 has-header">
        ...
        <div class="main-container container">
                    ...
                    <div class="swiper-container connectionwiper" style="overflow: scroll;">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="{{ url('sertifikat/cert/'.Crypt::encryptString($data[0]->regid)) }}" class="card text-center">
                                    <div class="card-body">
            ...
            <div class="row h-100 mb-4">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="form-group form-floating  mb-3">
                        <select disabled class="form-control" id="country" readonly>
                            @foreach($produk as $p)
				...
				<div class="col-12 col-md-6 col-lg-4">
                        <div class="form-floating mb-3">
                            <select disabled class="form-control" required name="asuransi" id="asuransi" readonly  >
                                <option value="" ></option>
				...
				<div class="col-12 col-md-6 col-lg-4">
                    <div class="form-group form-floating  mb-3">
                        <select disabled class="form-control" id="country" readonly>
                            @foreach($mitra as $c)
                            <option @if($c->comtabid == $data[0]->mitra) selected @endif>{{ $c->comtab_nm }}</option>
                            @endforeach
                        </select>
                        <label for="names">Mitra</label>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="form-group form-floating  mb-3">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="form-group form-floating  mb-3">
                        <select disabled class="form-control" id="country" readonly>
                            @foreach($jkel as $c)
                            <option @if($c->comtabid == $data[0]->jkel) selected @endif>{{ $c->comtab_nm }}</option>
                            @endforeach
                        </select>
            ...
            <div class="row h-100 ">
                <div class="card card-body col-12 mb-4 table-responsive">
                    <h5>Dokumen {{ $data[0]->regid }}</h5>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Jenis Dokumen</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('assets/'.$item->file) }}" target="pdf-frame" class="btn btn-sm btn-default"><i class="fa fa-file-pdf-o"></i> Document</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
