        ...
        <div class="main-container container">
            ...
            <form action="{{ url('sertifikat/topup/store') }}" method="post">
                ...
                <div class="row h-100 mb-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group form-floating  mb-3">
                            <input type="date" class="form-control" name="mulai" required value="{{ $data[0]->mulai }}" placeholder="Mulai Asuransi" id="names">
                            <label for="names">Mulai Asuransi</label>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group form-floating  mb-3">
                            <input type="text" class="form-control" name="masa" required placeholder="Masa Asuransi" id="names">
                            <label for="names">Masa Asuransi (Dalam Bulan)</label>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group form-floating  mb-3">
                            <input type="text" class="form-control" name="up" placeholder="Masa Asuransi"  requiredid="names" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);">
                            <label for="names">Uang Pertanggungan (Dalam Rupiah)</label>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group form-floating  mb-3">
                            <input type="text" class="form-control" name="tunggakan" min="0" max="1000" required placeholder="Masa Asuransi" id="names">
