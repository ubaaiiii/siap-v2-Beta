        ...
        <div class="main-container container">
            ...
            <form method="POST" action="{{ url('verifikasi/update')}}">
                ...
                <div class="row h-100 mb-4">
					...
					<div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group form-floating  mb-3">
                            <textarea class="form-control" name="catatan" rows="10">{{ $data[0]->comment }}</textarea>
                ...
                <div class="row">
                    ...
                    {{-- <div class="col-12 mt-3">
                        <div class="card card-body table-responsive">
                            <h5>Video</h5>
                            <div>
                                <video id="video" class="video-js vjs-fluid" controls>
                                <source src="{{ url('public/videos/vid-1.mp4') }}" type="video/mp4">
                            </div>
                            <div class="vjs-playlist">
                            </div>
                            <div class="row mt-3">
                                <div class="col-9">
                                    <video id="video" class="video-js w-100 vjs-fluid" controls>
                                        <source src="{{ url('public/videos/vid-1.mp4') }}">
                                    </video>
                                </div>
                                <div class="col-3" id="playlist" style="overflow-y: scroll;height: 100px">
                            ...
                            <script>
                                $(document).ready(function(){
                                    ...
                                    player.playlist([{
                                        name: 'Video Debitur Berjalan 1',
                                        sources: [
                                            {src: '{{ url('public/videos/vid-1.mp4') }}', type: 'video/mp4'},
                                        ],
                                            // you can use <picture> syntax to display responsive images
                                            thumbnail: [
                                                {
                                                    srcset: '{{ url("public/assets/photo/video.png") }}',
                                                    type: 'image/png',
                                                },
                                                {
                                                src: '{{ url("public/assets/photo/video.png") }}'
                                                }
                                            ]
                                        }
                                        , {
                                            name: 'Video Debitur Berjalan 2',
                                            sources: [{
                                                src: '{{ url('public/videos/vid-2.mp4') }}',
                                                type: 'video/mp4'
                                            }, ],
                                            // you can use <picture> syntax to display responsive images
                                            thumbnail: [
                                            ...
                                            name: 'Video Debitur Berjalan 3',
                                            sources: [{
                                                src: '{{ url('public/videos/vid-3.mp4') }}',
                                                type: 'video/mp4'
                                            }, ],
                                            // you can use <picture> syntax to display responsive images
                                            thumbnail: [
                                            ...
                                            name: 'Video Debitur Berjalan 4',
                                            sources: [{
                                                src: '{{ url('public/videos/vid-4.mp4') }}',
                                                type: 'video/mp4'
                                            }, ],
                                            // you can use <picture> syntax to display responsive images
                                            thumbnail: [
                                            ...
                                            name: 'Video Debitur Berjalan 5',
                                            sources: [{
                                                src: '{{ url('public/videos/vid-5.mp4') }}',
                                                type: 'video/mp4'
                                            }, ],
                                            // you can use <picture> syntax to display responsive images
                                            thumbnail: [
                                            ...
                                            name: 'Video Debitur Berjalan 6',
                                            sources: [{
                                                src: '{{ url('public/videos/vid-6.mp4') }}',
                                                type: 'video/mp4'
                                            }, ],
                                            // you can use <picture> syntax to display responsive images
                                            thumbnail: [
                                            ...
                                            sources: [{
                                                src: '{{ url('public/videos/vid-7.mp4') }}',
                                                type: 'video/mp4'
                                            }],
                                            thumbnail: [
                                                {
