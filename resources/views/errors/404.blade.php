...
<body class="body-scroll d-flex flex-column" data-page="404">
    <!-- Begin page content -->
        ...
        <div class="row h-100 ">
            <div class="col-12 col-md-6 col-lg-5 col-xl-3 mx-auto py-4 text-center align-self-center">
                <figure class="mw-100 text-center mb-3">
                    <img src="{{ url('assets/img/404.png') }}" alt="" class="mw-100">
                </figure>
                <h1 class="mb-0 text-color-theme">Oops!...</h1>
                <h5 class="mb-3">Page not found</h5>
                <p class="text-muted mb-4">Mungin url atau file yang anda cari tidak ada. Anda dapat segera menghubungi admin atau dapat kembali ke halaman utama.</p>
